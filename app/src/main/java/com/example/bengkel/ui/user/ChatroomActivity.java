...
import com.example.bengkel.adapter.ChatMessageRecyclerAdapter;
import com.example.bengkel.model.Account;
import com.example.bengkel.model.ChatMessage;
import com.example.bengkel.model.Chatroom;
import com.example.bengkel.model.User;
import com.example.bengkel.model.UserLocation;
import com.example.bengkel.util.UserClient;
        ...
        View.OnClickListener
{
    ...
    private void insertNewMessage(){
        ...
        if(!message.equals("")){
            ...
            account.setId(auth.getUid());
            account.setAktif("");
            account.setEmail("");
            account.setRole("");
//            Log.d(TAG, "insertNewMessage: retrieved user client: " + account.toString());
            newChatMessage.setAccount(account);
