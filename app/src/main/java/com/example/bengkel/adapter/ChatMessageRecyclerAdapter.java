...
public class ChatMessageRecyclerAdapter extends RecyclerView.Adapter<ChatMessageRecyclerAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        if(FirebaseAuth.getInstance().getUid().equals(mMessages.get(position).getAccount().getId())){
        ...
        ((ViewHolder)holder).username.setText(mMessages.get(position).getAccount().getEmail());
